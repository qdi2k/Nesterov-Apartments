...
import BurgerList from '@/features/burgerList/BurgerList'
...
export default function Burger({isOpen, onPress}: IBurgerProps) {
  return (
    <div
      className={
        isOpen ? 
      ...
      onClick={() => onPress()}>
      <div className={isOpen ? `${styles.menuContent}` : `${styles.menuContent} ${styles.contentClosed}`} onClick={e => e.stopPropagation()}>
