...
class DBAuthProvider(AuthProvider):
    """
    ## Провайдер аутентификации администраторов через БД.

    Обеспечивает:
    - Вход по логину/паролю с проверкой активности пользователя;
    - Верификацию аутентификации по сессии;
    - Доступ к данным текущего администратора;
